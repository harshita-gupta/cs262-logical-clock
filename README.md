...
You will turn in both the code (or a pointer to your repo containing the code) and the lab notebook.


Rubric
Description of criterion
Does the notebook clearly state how the model was built? What experiments were run? What was done in addition to what was assigned?
5.0 pts
Full Marks
0.0 pts
No Marks
5.0 pts
This criterion is linked to a Learning Outcome Observations on running the model
Does the notebook describe what happened when running the model? Were any conclusions drawn as to what the observations mean?
5.0 pts
Full Marks
0.0 pts
No Marks
